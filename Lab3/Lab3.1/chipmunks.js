...
saturateBtn.addEventListener("click", () => addFilter(targetImage, "saturate(30%)"));
opacityBtn.addEventListener("click", () => addFilter(targetImage, "opacity(25%)"));
invertBtn.addEventListener("click", () => addFilter(targetImage, "invert(75%)"));
sepiaBtn.addEventListener("click", () => addFilter(targetImage, "sepia(60%)"));
grayscaleBtn.addEventListener("click", () => addFilter(targetImage, "grayscale(50%)"));